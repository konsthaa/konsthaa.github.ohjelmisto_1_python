...
document.addEventListener('DOMContentLoaded', () => {
    const section = document.querySelector('section'); // the container

    // Example picArray – this should already exist in the starter code
    const picArray = [
        {
        ...
        },
        {
            ...
            caption: "Crashing waves at dawn",
            description: "Early morning at the beach with powerful waves rolling in."
        },
        {
            title: "Forest Path",
            image: "images/forest.jpg",
            caption: "Misty forest trail",
            description: "A peaceful walking path through an ancient forest covered in fog."
        }
    ];

    // Loop through each object in picArray
    picArray.forEach(pic => {
        ...
        // Add the complete article to the <section>
